                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('jadwal.update', $jadwal) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="jam_mulai" name="jam_mulai" type="time" class="mt-1 block w-full" :value="old('jam_mulai', substr($jadwal->jam_mulai, 0, 5))" required />
                            <x-input-error :messages="$errors->get('jam_mulai')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="jam_selesai" value="Jam Selesai" />
                            <x-text-input id="jam_selesai" name="jam_selesai" type="time" class="mt-1 block w-full" :value="old('jam_selesai', substr($jadwal->jam_selesai, 0, 5))" required />
